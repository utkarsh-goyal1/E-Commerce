...
router.post('/products' ,validateProduct, async(req,res)=>{//Here validateProduct is our server side validation .When it validates the product then it will call next() function which we have defined followed by validateProduct
    try{
